...
export async function insertUser(user: User): Promise<User> {
  ...
  const { rows } = await pool.query(
    `INSERT INTO users (id, nome, email, celular, password_hash, tipo, ativo, aluno_id, foto, faixa_atual, graus, created_at)
